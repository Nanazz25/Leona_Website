        ...
        <div class="mdc-list-group">
            <nav class="mdc-list mdc-drawer-menu">
                ...
                <div class="mdc-list-item mdc-drawer-item">
                    ...
                    <div class="mdc-expansion-panel" id="submenu-identitas-user">
                        <nav class="mdc-list mdc-drawer-submenu">
                            <div class="mdc-list-item mdc-drawer-item">
                                <a class="mdc-drawer-link" href="{{ url('/user-guru') }}">guru dan kurikulum</a>
                            </div>
                            <div class="mdc-list-item mdc-drawer-item">
                                <a class="mdc-drawer-link" href="{{ url('/usermurid') }}">murid</a>
                            </div>
                        </nav>
                    </div>
                </div>
